...
export class RecipesController {
  ...
  private getUserId(user: any, headerUserId?: string, bodyUserId?: any): bigint {
  ...
  addTagToRecipe(
    ...
    return this.recipesService.addTagToRecipe(BigInt(id), BigInt(body.tagId), userId);
  }
  ...
  removeTagFromRecipe(
    ...
    const userId = this.getUserId(user, headerUserId);
    return this.recipesService.removeTagFromRecipe(BigInt(id), BigInt(tagId), userId);
  }
}
