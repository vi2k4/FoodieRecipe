...
async function main() {
  ...
  const catMain = await prisma.recipeCategory.create({
    data: {
      id: 1n,
      name: 'Món chính',
      description: 'Các món ăn chính cho bữa trưa và tối',
      icon: 'Utensils',
    },
  });
  const catAppetizer = await prisma.recipeCategory.create({
    data: {
      id: 2n,
      name: 'Món khai vị',
      description: 'Các món nhẹ kích thích vị giác',
      icon: 'Salad',
    },
  });
  const catDessert = await prisma.recipeCategory.create({
    data: {
      id: 3n,
      name: 'Đồ tráng miệng',
      description: 'Các món ngọt, bánh, chè',
      icon: 'Cake',
    },
  });
  const catDrink = await prisma.recipeCategory.create({
    data: {
      id: 4n,
      name: 'Nước uống',
      description: 'Sinh tố, nước ép, cà phê',
      icon: 'Coffee',
    },
  });
  const catVegan = await prisma.recipeCategory.create({
    data: {
      id: 5n,
      name: 'Món chay',
      description: 'Các món thuần chay lành mạnh',
      icon: 'Leaf',
    },
  });
  ...
  const tagSoup = await prisma.tag.create({
    data: { id: 2n, name: 'Món nước' },
  });
  const tagFry = await prisma.tag.create({ data: { id: 3n, name: 'Đồ rán' } });
  const tagHealthy = await prisma.tag.create({
    data: { id: 4n, name: 'Tốt cho sức khỏe' },
  });
  const tagTrad = await prisma.tag.create({
    data: { id: 5n, name: 'Truyền thống' },
  });
  ...
  const r1 = await prisma.recipe.create({
    data: {
      ...
      servings: 4,
      thumbnail:
        'https://images.unsplash.com/photo-1583002621742-881c9c72e2cf?auto=format&fit=crop&q=80&w=600',
      likeCount: 5n,
      favoriteCount: 3n,
      averageRating: 4.8,
      createdAt: subDays(new Date(), 6),
  ...
  const r2 = await prisma.recipe.create({
    data: {
      ...
      servings: 6,
      thumbnail:
        'https://images.unsplash.com/photo-1541783245831-57d6fb0926d3?auto=format&fit=crop&q=80&w=600',
      likeCount: 4n,
      favoriteCount: 2n,
      averageRating: 4.5,
      createdAt: subDays(new Date(), 5),
  ...
  await prisma.recipeIngredient.createMany({
    data: [
      ...
      {
        recipeId: 1n,
        ingredientName: 'Xương bò (ống tuỷ)',
        quantity: 1.5,
        unit: 'kg',
        displayOrder: 1,
      },
      {
        recipeId: 1n,
        ingredientName: 'Thịt bò tái (nạm, gầu)',
        quantity: 500,
        unit: 'g',
        displayOrder: 2,
      },
      ...
      {
        recipeId: 1n,
        ingredientName: 'Nước mắm, muối, đường phèn',
        quantity: null,
        unit: 'vừa đủ',
        displayOrder: 8,
      },
      {
        recipeId: 1n,
        ingredientName: 'Hành lá, ngò gai, giá đỗ, chanh, ớt',
        quantity: null,
        unit: 'kèm ăn',
        displayOrder: 9,
      },
      ...
      {
        recipeId: 2n,
        ingredientName: 'Sữa đặc có đường',
        quantity: 100,
        unit: 'ml',
        displayOrder: 3,
      },
      ...
      {
        recipeId: 3n,
        ingredientName: 'Tương đậu đen (doubanjiang)',
        quantity: 2,
        unit: 'muỗng canh',
        displayOrder: 2,
      },
      ...
      {
        recipeId: 3n,
        ingredientName: 'Nước tương, đường, tinh bột năng',
        quantity: null,
        unit: 'vừa đủ',
        displayOrder: 5,
      },
  ...
  await prisma.recipeStep.createMany({
    data: [
      // Phở bò (recipe 1)
      {
        ...
        stepNumber: 1,
        content:
          'Xương bò rửa sạch, chần qua nước sôi 5 phút rồi rửa lại với nước lạnh để loại bỏ tạp chất.',
      },
      {
        recipeId: 1n,
        stepNumber: 2,
        content:
          'Nướng hành tây và gừng trên lửa trực tiếp hoặc trong lò nướng đến khi vỏ ngoài cháy đen, rồi cạo sạch lớp đen bên ngoài.',
      },
      {
        recipeId: 1n,
        stepNumber: 3,
        content:
          'Rang khô hoa hồi, quế và gia vị phở đến khi dậy mùi thơm. Cho vào túi lọc gia vị.',
      },
      {
        recipeId: 1n,
        stepNumber: 4,
        content:
          'Cho xương vào nồi lớn, đổ nước ngập xương (khoảng 4-5 lít), đun sôi rồi hạ lửa nhỏ. Thêm hành tây, gừng nướng và túi gia vị, ninh ít nhất 3 tiếng.',
      },
      {
        recipeId: 1n,
        stepNumber: 5,
        content:
          'Nêm nước dùng với nước mắm, muối và đường phèn cho vừa khẩu vị. Nước dùng chuẩn phải trong, có vị ngọt tự nhiên từ xương.',
      },
      {
        recipeId: 1n,
        stepNumber: 6,
        content:
          'Trụng bánh phở qua nước sôi, cho vào tô. Thái thịt bò thật mỏng xếp lên mặt. Chan nước dùng nóng bỏng vào tô, trang trí với hành lá và ngò gai.',
      },
      // Bánh flan (recipe 2)
      {
        recipeId: 2n,
        stepNumber: 1,
        content:
          'Làm caramel: đun đường và nước trên lửa vừa, không khuấy, đến khi chuyển màu vàng cánh gián đẹp. Đổ ngay vào khuôn, nghiêng đều để caramel phủ đáy khuôn.',
      },
      {
        recipeId: 2n,
        stepNumber: 2,
        content:
          'Đánh trứng với sữa đặc, sau đó từ từ thêm sữa tươi ấm (không nóng quá). Thêm vani khuấy đều.',
      },
      {
        recipeId: 2n,
        stepNumber: 3,
        content:
          'Lọc hỗn hợp trứng qua rây mịn 2-3 lần để loại bỏ bọt khí và màng trứng, giúp bánh mịn không bị rỗ.',
      },
      {
        recipeId: 2n,
        stepNumber: 4,
        content:
          'Đổ hỗn hợp vào khuôn có caramel. Đặt khuôn vào khay nước nóng (cách thủy), hấp hoặc nướng ở 150°C trong 40-45 phút đến khi bánh đặc lại.',
      },
      {
        recipeId: 2n,
        stepNumber: 5,
        content:
          'Để nguội hoàn toàn rồi cho vào tủ lạnh ít nhất 4 tiếng. Khi ăn, dùng dao nhỏ rạch cạnh khuôn và úp ngược bánh ra đĩa.',
      },
      // Đậu hũ (recipe 3)
      {
        recipeId: 3n,
        stepNumber: 1,
        content:
          'Cắt đậu hũ thành khối vuông 2cm. Dầu mè nóng vàng, chiên đậu hũ đến vàng đều các mặt rồi vớt ra.',
      },
      {
        recipeId: 3n,
        stepNumber: 2,
        content:
          'Phi thơm tỏi gừng, thêm tương đậu đen xào đến khi dậy mùi thơm đặc trưng và dầu chuyển màu đỏ.',
      },
      {
        recipeId: 3n,
        stepNumber: 3,
        content:
          'Cho đậu hũ vào xào cùng, thêm nước tương, đường và một ít nước. Đun nhỏ lửa khoảng 5 phút.',
      },
      {
        recipeId: 3n,
        stepNumber: 4,
        content:
          'Pha tinh bột năng với nước lạnh, đổ từ từ vào chảo, đảo đều đến khi sốt sánh lại. Rắc tiêu xanh và hành lá rồi tắt bếp.',
      },
    ],
  });
    ...
    data: [
      {
        ...
        recipeId: 1n,
        userId: 3n,
        content: 'Nước lèo rất trong và ngọt thanh, đúng vị Phở Hà Nội!',
      },
      {
        id: 2n,
        recipeId: 1n,
        userId: 4n,
        content: 'Bánh phở mềm dai vừa phải. Rất xuất sắc!',
      },
      {
        id: 3n,
        recipeId: 2n,
        userId: 2n,
        content: 'Bánh béo ngậy, mịn màng không hề bị tanh mùi trứng.',
      },
      {
        id: 4n,
        recipeId: 3n,
        userId: 5n,
        content: 'Món này ăn với cơm nóng vào mùa đông thì tuyệt vời.',
      },
    ],
  });
  ...
  await prisma.report.createMany({
    data: [
      ...
      },
      {
        ...
        description:
          'Ảnh thumbnail là gỏi cuốn nhưng công thức lại hướng dẫn làm gỏi xoài.',
        status: ReportStatus.PENDING,
        createdAt: subDays(new Date(), 1),
      },
      {
    ...
    data: [
      {
        ...
        content:
          'lan_anh đã bình luận về công thức "Phở bò truyền thống" của bạn.',
      ...
      },
      {
        ...
        content:
          'minh_chay đã báo cáo công thức "Bánh flan sữa tươi siêu mịn".',
